...
# Versions
export BUN_VERSION="${BUN_VERSION:-1.3.2}"
export BUN_TAG="bun-v${BUN_VERSION}"
export WEBKIT_COMMIT="${WEBKIT_COMMIT:-6d0f3aac0b817cc01a846b3754b21271adedac12}"
export ICU_VERSION="${ICU_VERSION:-75.1}"
export ZIG_VERSION="${ZIG_VERSION:-0.15.2}"
export OPENCODE_VERSION="${OPENCODE_VERSION:-1.18.16}"
...
export BUN_SRC="${WORK_DIR}/bun-${BUN_VERSION}-src"
export WEBKIT_SRC="${WORK_DIR}/webkit-${WEBKIT_COMMIT}-src"
...
export WEBKIT_BUILD="${WORK_DIR}/webkit-${WEBKIT_COMMIT}-build"
export WEBKIT_OUTPUT="${WORK_DIR}/webkit-${WEBKIT_COMMIT}-android"
export BUN_BUILD="${WORK_DIR}/bun-${BUN_VERSION}-build"
